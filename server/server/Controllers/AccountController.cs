...
namespace server.Controllers
{
  ...
  public class AccountController : ControllerBase
  {
    ...
    public AccountController(IAccountManager accountManager, IUserManager userManager, ITransactionManager transactionManager)
    {
    ...
    public ActionResult<Transaction> ValidateAndCreateEliminatingTransaction([FromBody] EliminateTransactionDto request)
    {
      ...
      Transaction newTransaction = _transactionManager.CreateEliminatingTransaction(request.AccountId, request.NewValue - sum);
