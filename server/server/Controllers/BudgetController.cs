...
namespace server.Controllers
{
    ...
    public class BudgetController : ControllerBase
    {
        ...
        public BudgetController(ITransactionManager transactionManager, IBudgetManager budgetManager)
        {
        ...
        {
            IQueryable<Budget> budgets = null;
            budgets = _budgetManager.GetBudgets(userId);
            return Ok(budgets);
        }
